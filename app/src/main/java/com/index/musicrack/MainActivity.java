...
//        playMusic(paths);
        ...
        for(int i = 0; i < paths.size(); i++){
            Music music = new Music(String.valueOf(i),String.valueOf(i), paths.get(i));
            musics.add(music);
        }

        adapter = new MusicAdapter(this,android.R.layout.simple_expandable_list_item_1, musics);
